...
export class SnowflakeClient {
   ...
   * Uses snowflake-arctic-embed-l (1024 dimensions) to match VECTOR(FLOAT, 1024).
   */
  async ingestDocumentChunk(params: {
    ...
    await this.executeQuery(`
      ...
      SELECT
        :1, :2, :3, :4, :5,
        SNOWFLAKE.CORTEX.EMBED_TEXT_1024('snowflake-arctic-embed-l', :2)
    `, {
  ...
  /**
   * Vector similarity search: find the top-k chunks most relevant to queryText.
   * Uses Snowflake Cortex EMBED_TEXT_1024 for the query embedding.
   */
    ...
    return await this.executeQuery(`
      SELECT
        ...
        VECTOR_COSINE_SIMILARITY(
          c.EMBEDDING,
          SNOWFLAKE.CORTEX.EMBED_TEXT_1024('snowflake-arctic-embed-l', :1)
        ) AS SIMILARITY
